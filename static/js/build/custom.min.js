...
function init_flot_chart() {
    if ("undefined" != typeof $.plot) {
        ...
        $("#chart_plot_01").length && ($.plot($("#chart_plot_01"), [a, b], g)),
        ...
        $("#chart_plot_03").length && ($.plot($("#chart_plot_03"), [{
            label: "Registrations",
            data: e,
            lines: {
                fillColor: "rgba(150, 202, 89, 0.12)"
...
function init_chart_doughnut() {
    if ("undefined" != typeof Chart && ($(".canvasDoughnut").length)) {
        const group_index_1 = document.getElementById("group_index_1").innerHTML
        const group_index_2 = document.getElementById("group_index_2").innerHTML
        const group_index_3 = document.getElementById("group_index_3").innerHTML
        const group_index_4 = document.getElementById("group_index_4").innerHTML
        const group_index_5 = document.getElementById("group_index_5").innerHTML
        var a = {
            type: "doughnut",
            tooltipFillColor: "rgba(51, 51, 51, 0.55)",
            data: {
                labels: ["Linux", "Windows", "网络设备", "安全设备", "其他"],
                datasets: [{
                    data: [group_index_1, group_index_2, group_index_3, group_index_4, group_index_5],
...
function init_InputMask() {
    "undefined" != typeof $.fn.inputmask && ($(":input").inputmask())
}
function init_ColorPicker() {
    "undefined" != typeof $.fn.colorpicker && ($(".demo1").colorpicker(), $(".demo2").colorpicker(), $("#demo_forceformat").colorpicker({
        format: "rgba",
        horizontal: !0
...
function init_IonRangeSlider() {
    "undefined" != typeof $.fn.ionRangeSlider && ($("#range_27").ionRangeSlider({
        type: "double",
        min: 1e6,
        max: 2e6,
        grid: !0,
...
function init_SmartWizard() {
    "undefined" != typeof $.fn.smartWizard && ($("#wizard").smartWizard(), $("#wizard_verticle").smartWizard({
